...
class StoreDataObj {
  ...
  factory StoreDataObj.fromJson(Map<String, dynamic> json) => StoreDataObj(
    ...
    storeName: json["store_name"] == null ? null : json["store_name"].toString(),
    ...
    contactPerson: json["contact_person"] == null ? null : json["contact_person"].toString(),
    contactNumber: json["contact_number"] == null ? null : json["contact_number"].toString(),
    contactEmail: json["contact_email"] == null ? null : json["contact_email"].toString(),
    ...
    showCurrency: json["show_currency"] == null ? null : json["show_currency"].toString(),
    type: json["type"] == null ? null : json["type"].toString(),
    catType: json["cat_type"] == null ? null : json["cat_type"].toString(),
    storeLogo: json["store_logo"] == null ? null : json["store_logo"].toString(),
    preparationTime: json["preparation_time"] == null ? null : json["preparation_time"].toString(),
    orderFacilities: json["order_facilities"] == null ? null : json["order_facilities"].toString(),
    modified: json["modified"] == null ? null : DateTime.parse(json["modified"]),
    banner: json["banner"] == null ? null : json["banner"].toString(),
    storeStatus: json["store_status"] == null ? null : json["store_status"].toString(),
    storeMsg: json["store_msg"] == null ? null : json["store_msg"].toString(),
    homePageTitleStatus: json["home_page_title_status"] == null ? null : json["home_page_title_status"],
    homePageTitle: json["home_page_title"] == null ? null : json["home_page_title"].toString(),
    ...
    fbPixelKey: json["fb_pixel_key"] == null ? null : json["fb_pixel_key"].toString(),
    gaPixelKey: json["ga_pixel_key"] == null ? null : json["ga_pixel_key"].toString(),
    noCatHomePage: json["no_cat_home_page"] == null ? null : json["no_cat_home_page"].toString(),
    noProductHomePage: json["no_product_home_page"] == null ? null : json["no_product_home_page"].toString(),
    ...
    recommendedProducts: json["recommended_products"] == null ? null : json["recommended_products"].toString(),
    deliverySlot: json["delivery_slot"] == null ? null : json["delivery_slot"].toString(),
    geofencing: json["geofencing"] == null ? null : json["geofencing"].toString(),
    loyality: json["loyality"] == null ? null : json["loyality"].toString(),
    pickupFacility: json["pickup_facility"] == null ? null : json["pickup_facility"].toString(),
    deliveryFacility: json["delivery_facility"] == null ? null : json["delivery_facility"].toString(),
    inStore: json["in_store"] == null ? null : json["in_store"].toString(),
    internationalOtp: json["international_otp"] == null ? null : json["international_otp"].toString(),
    multipleStore: json["multiple_store"] == null ? null : json["multiple_store"].toString(),
    webMenuSetting: json["web_menu_setting"] == null ? null : json["web_menu_setting"].toString(),
    mobileNotifications: json["mobile_notifications"] == null ? null : json["mobile_notifications"].toString().toString(),
    emailNotifications: json["email_notifications"] == null ? null : json["email_notifications"].toString(),
    smsNotifications: json["sms_notifications"] == null ? null : json["sms_notifications"].toString(),
    gst: json["gst"] == null ? null : json["gst"].toString(),
    runnerManagement: json["runner_management"] == null ? null : json["runner_management"].toString(),
    gaCode: json["ga_code"] == null ? null : json["ga_code"].toString(),
    categoryLayout: json["category_layout"] == null ? null : json["category_layout"].toString(),
    deliveryArea: json["delivery_area"] == null ? null : json["delivery_area"].toString(),
    radiusIn: json["radius_in"] == null ? null : json["radius_in"].toString(),
    productImage: json["product_image"] == null ? null : json["product_image"].toString(),
    is24X7Open: json["is24x7_open"] == null ? null : json["is24x7_open"].toString(),
    openhoursFrom: json["openhours_from"] == null ? null : json["openhours_from"].toString(),
    openhoursTo: json["openhours_to"] == null ? null : json["openhours_to"].toString(),
    closehoursMessage: json["closehours_message"] == null ? null : json["closehours_message"].toString(),
    storeOpenDays: json["store_open_days"] == null ? null : json["store_open_days"].toString(),
    ...
    banner10080: json["banner_100_80"] == null ? null : json["banner_100_80"].toString(),
    banner300200: json["banner_300_200"] == null ? null : json["banner_300_200"].toString(),
    repeatOrder: json["repeat_order"] == null ? null : json["repeat_order"].toString(),
  );
